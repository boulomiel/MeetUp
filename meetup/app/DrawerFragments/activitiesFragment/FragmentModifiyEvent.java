...
public class FragmentModifiyEvent extends Fragment {
    ...
    private String adress_bundle ;
    private String kind_bundle ;
    private String place_bundle ;
    private String date_bundle ;
    private String time_bundle ;
    private String end_bundle ;
    private String img_bundle ;
    private String name_bundle ;



    public FragmentModifiyEvent(){}
    ...
    public void onStart() {
        ...
        if (bundle != null) {
            ...
            System.out.println("BUNDLE " +" " + bundle ==  null);
            adress_bundle = bundle.getString("adress");
            name_bundle = bundle.getString("name");
            kind_bundle = bundle.getString("kind");
            place_bundle = bundle.getString("place");
            date_bundle = bundle.getString("date");
            time_bundle = bundle.getString("time");
            end_bundle = bundle.getString("end");
            img_bundle =bundle.getString("img_url");



            setAncientContent(adress_bundle,name_bundle,kind_bundle,place_bundle,date_bundle,time_bundle,end_bundle);
    ...
    private void swithIcon(String activity){
        switch (activity){
            case  "Bar" :
    ...
    private void setAncientContent(String adress_bdl , String name ,  String kind ,
                                   String place , String date, String time, String end_time){

       activity_name.setText(name);
       activity_time.setText(time);
       activity_endtime.setText(end_time);
       activity_date.setText(date);
       chosen_activity_type.setText(kind) ;
       picked_where.setText(place);
       adress.setText(adress_bdl) ;
       swithIcon(kind);
    }
        ...
        if(checkFields(activityName,activityDate,activityTime,activityEndTime,adress_str)){
            ...
            mRef.setValue(activityMap).addOnSuccessListener(new OnSuccessListener<Void>() {
                ...
                public void onSuccess(Void aVoid) {
                    ...
                    Snackbar.make(getView(),"Event successfully modified !", Snackbar.LENGTH_SHORT).show();
                }
